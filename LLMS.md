...
- [Content APIs v4](https://api-docs.quran.foundation/openAPI/content/v4.json): Verses, chapters,
  translations, tafsirs, audio
- [User APIs v1 (Production)](https://api-docs.quran.foundation/openAPI/user-related-apis/v1.json):
  Stable production documentation for bookmarks, collections, notes, profiles, rooms, posts
- [User APIs v1 (Pre-live)](https://api-docs.quran.foundation/openAPI/user-related-apis/pre-live/v1.json):
  Upcoming pre-live documentation for unreleased user API changes
- [OAuth2 APIs v1](https://api-docs.quran.foundation/openAPI/oauth2-apis/v1.json): Authentication
  and authorization
...
- [Count answers within a verse range](https://api-docs.quran.foundation/docs/content_apis_versioned/count-answers-within-range)
- [Get answer thread by question ID](https://api-docs.quran.foundation/docs/content_apis_versioned/get-answer-by-id)
...
- [Get hadith counts within a verse range](https://api-docs.quran.foundation/docs/content_apis_versioned/hadith-count-within-range)
- [Get hadith references for a specific Ayah](https://api-docs.quran.foundation/docs/content_apis_versioned/hadith-references-by-ayah)
- [Get hadiths for a specific Ayah](https://api-docs.quran.foundation/docs/content_apis_versioned/hadiths-by-ayah)
- [Languages](https://api-docs.quran.foundation/docs/content_apis_versioned/languages)
- [Get answers for specific Ayah](https://api-docs.quran.foundation/docs/content_apis_versioned/list-ayah-answers)
...
- [Get tafsirs for specific Rub el Hizb (alias: /by_rub)](https://api-docs.quran.foundation/docs/content_apis_versioned/list-rub-el-hizb-tafsirs-rub)
- [Get tafsirs for specific Rub el Hizb](https://api-docs.quran.foundation/docs/content_apis_versioned/list-rub-el-hizb-tafsirs)
- [Get translations for specific Rub el Hizb (alias: /by_rub)](https://api-docs.quran.foundation/docs/content_apis_versioned/list-rub-el-hizb-translations-rub)
- [Get translations for specific Rub el Hizb](https://api-docs.quran.foundation/docs/content_apis_versioned/list-rub-el-hizb-translations)
...
- [By Rub el Hizb number (alias: /by_rub_el_hizb)](https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-rub-el-hizb-number-rub-el-hizb)
- [By Rub el Hizb number](https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-rub-el-hizb-number)
...
- [Add collection Bookmark](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-collection-bookmark)
- [Add collection](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-collection)
- [Add note](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-note)
- [Add or update preference](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-or-update-preference)
- [Add or update user reading session](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-or-update-user-reading-session)
- [Add/update activity day](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-update-activity-day)
- [Add user bookmark](https://api-docs.quran.foundation/docs/user_related_apis_versioned/add-user-bookmark)
- [Bulk add or update preferences](https://api-docs.quran.foundation/docs/user_related_apis_versioned/bulk-add-or-update-preferences)
...
- [Create a goal](https://api-docs.quran.foundation/docs/user_related_apis_versioned/create-a-goal)
- [Delete a goal](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-a-goal)
- [Delete Bookmark](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-bookmark)
- [Delete collection bookmark by details](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-collection-bookmark-by-details)
- [Delete collection bookmark by id](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-collection-bookmark-by-id)
- [Delete collection](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-collection)
- [Delete note by ID](https://api-docs.quran.foundation/docs/user_related_apis_versioned/delete-note-by-id)
- [Estimate reading time](https://api-docs.quran.foundation/docs/user_related_apis_versioned/estimate-reading-time)
- [Generate timeline estimation](https://api-docs.quran.foundation/docs/user_related_apis_versioned/generate-timeline-estimation)
- [Get activity days](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-activity-days)
- [Get all collection items](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-all-collection-items)
- [Get all collections](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-all-collections)
- [Get all notes](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-all-notes)
- [Get bookmark collections](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-bookmark-collections)
- [Get bookmark](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-bookmark)
- [Get bookmarks within a range of Ayahs](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-bookmarks-within-a-range-of-ayahs)
- [Get collection items by id](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-collection-items-by-id)
- [Get current streak days](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-current-streak-days)
- [Get note by ID](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-note-by-id)
- [Get notes by attached entity](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-notes-by-attached-entity)
- [Get notes by verse range](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-notes-by-verse-range)
- [Get notes by verse](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-notes-by-verse)
- [Get notes count within verse range](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-notes-count-within-verse-range)
- [Get streaks](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-streaks)
- [Get today's goal plan](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-todays-goal-plan)
- [Get user bookmarks](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-user-bookmarks)
- [Get user preferences](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-user-preferences)
- [Get user reading sessions](https://api-docs.quran.foundation/docs/user_related_apis_versioned/get-user-reading-sessions)
...
- [Publish note](https://api-docs.quran.foundation/docs/user_related_apis_versioned/publish-note)
...
- [Update a goal](https://api-docs.quran.foundation/docs/user_related_apis_versioned/update-a-goal)
- [Update collection](https://api-docs.quran.foundation/docs/user_related_apis_versioned/update-collection)
- [Update note by ID](https://api-docs.quran.foundation/docs/user_related_apis_versioned/update-note-by-id)
...
- [Add collection Bookmark](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-collection-bookmark)
- [Add collection](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-collection)
- [Add note](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-note)
- [Add or update preference](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-or-update-preference)
- [Add or update user reading session](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-or-update-user-reading-session)
- [Add/update activity day](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-update-activity-day)
- [Add user bookmark](https://api-docs.quran.foundation/docs/user_related_apis_prelive/add-user-bookmark)
- [Bulk add or update preferences](https://api-docs.quran.foundation/docs/user_related_apis_prelive/bulk-add-or-update-preferences)
...
- [Create a goal](https://api-docs.quran.foundation/docs/user_related_apis_prelive/create-a-goal)
- [Delete a goal](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-a-goal)
- [Delete Bookmark](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-bookmark)
- [Delete collection bookmark by details](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-collection-bookmark-by-details)
- [Delete collection bookmark by id](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-collection-bookmark-by-id)
- [Delete collection](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-collection)
- [Delete note by ID](https://api-docs.quran.foundation/docs/user_related_apis_prelive/delete-note-by-id)
- [Estimate reading time](https://api-docs.quran.foundation/docs/user_related_apis_prelive/estimate-reading-time)
- [Generate timeline estimation](https://api-docs.quran.foundation/docs/user_related_apis_prelive/generate-timeline-estimation)
- [Get activity days](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-activity-days)
- [Get all collection items](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-all-collection-items)
- [Get all collections](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-all-collections)
- [Get all notes](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-all-notes)
- [Get bookmark collections](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-bookmark-collections)
- [Get bookmark](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-bookmark)
- [Get bookmarks within a range of Ayahs](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-bookmarks-within-a-range-of-ayahs)
- [Get collection items by id](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-collection-items-by-id)
- [Get current streak days](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-current-streak-days)
- [Get mutations](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-mutations)
- [Get note by ID](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-note-by-id)
- [Get notes by attached entity](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-notes-by-attached-entity)
- [Get notes by verse range](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-notes-by-verse-range)
- [Get notes by verse](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-notes-by-verse)
- [Get notes count within verse range](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-notes-count-within-verse-range)
- [Get streaks](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-streaks)
- [Get today's goal plan](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-todays-goal-plan)
- [Get user bookmarks](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-user-bookmarks)
- [Get user preferences](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-user-preferences)
- [Get user reading sessions](https://api-docs.quran.foundation/docs/user_related_apis_prelive/get-user-reading-sessions)
...
- [Publish note](https://api-docs.quran.foundation/docs/user_related_apis_prelive/publish-note)
...
- [Sync local mutations](https://api-docs.quran.foundation/docs/user_related_apis_prelive/sync-local-mutations)
- [Search and retrieve tags](https://api-docs.quran.foundation/docs/user_related_apis_prelive/tags-controller-find)
- [Update a goal](https://api-docs.quran.foundation/docs/user_related_apis_prelive/update-a-goal)
- [Update collection](https://api-docs.quran.foundation/docs/user_related_apis_prelive/update-collection)
- [Update note by ID](https://api-docs.quran.foundation/docs/user_related_apis_prelive/update-note-by-id)
